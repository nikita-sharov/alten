...
namespace Alten.Career.ViewModels
{
    public class JobApplicationViewModel
    {
        ...
        [Display(
            ...
            Description = "Please upload your application documents below(CVs, certificates, other documents), preferably in DOC, DOCX, PDF, PNG, JPEG or JPG. Make sure that each file is not larger than 4MB.",
            Prompt = "Choose file")]
